...
public final class AuthenticationTokenDetails {
    ...
    private AuthenticationTokenDetails(String id, String username, Set<Role> roles, ZonedDateTime issuedDate, ZonedDateTime expirationDate, int refreshCount, int refreshLimit) {
        this.id = id;
